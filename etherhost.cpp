...
#include "FLTDY\Fmgdefs.h" //A�ADIDO 1/04
...
/*
int sendtest=5;         //==========================VALOR DE PRUEBA  //A�ADIDO POR MANOLO
*/
...
static sockaddr_in SENDERR_Dest;    //A�ADIDO POR MANOLO
static sockaddr_in SENDERR_Dest2;    //A�ADIDO POR MANOLO_12_04
static sockaddr_in SENDERR_Dest3;    //A�ADIDO POR MANOLO_12_04
...
static int SENDER_Socket_desc;  //A�ADIDO POR MANOLO
static int SENDER_Socket_desc2;  //A�ADIDO POR MANOLO_12_04
static int SENDER_Socket_desc3;  //A�ADIDO POR MANOLO_12_04

//static int SENDER_Socket_descVis;  //A�ADIDO POR MANOLO_12_04 //FLIGHTGEAR_14_08_19 
...
int ET_init_SIMULINKscr()  //A�ADIDO POR MANOLO_12_04
{
	int  ret;
	char ptr = 0;
...
void ET_ex_SIMULINKscr()  //A�ADIDO POR MANOLO_12_04
{
	int bytes_sent;
...
int ET_init_SIMULINKhdw()  //A�ADIDO POR MANOLO_12_04
{
	int  ret;
	char ptr = 0;
