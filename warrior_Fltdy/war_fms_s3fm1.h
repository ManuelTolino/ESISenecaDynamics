...
const float thrust_scale = (float) 2.5f;//0.70;//0.80;
...
const float auth_pitch_trim  = (float) 1.5;//CJ 0.80; //0.50;
...
const float max_rpm = (float) (3400.0*RPM2RPS);
const float max_bhp = (float) 18620.0;
...
const float Qstart    = 1000.0f;//50.0; //100.0; // starter motor torque
...
const float rpm_hi    = (float) (3400.0 * (2*PI)/60.0);
...
const float prop_rad  = (float) 1.965; // m
const float prop_area = (float) 6.93; // m^2
...
const float elev_max = (float) 25.0; //25.0;
